...
export default function PushToShipBluButton({ orderId }: { orderId: string }) {
  ...
  async function push() {
    ...
    try {
      const res = await fetch(
        `/api/admin/orders/${encodeURIComponent(orderId)}/push-shipblu`,
        { method: "POST" }
      );
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        {pushing ? "Pushing…" : "Push to ShipBlu"}
      </button>
