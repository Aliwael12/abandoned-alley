...
const PINS: Pin[] = [
  { src: "/media/pins-bg/pin-bg-getfly.png", left: 4, top: 9, vw: 9.5, px: 96, fx: -60, fy: -18, fr: -160, rot: -13, delay: 0 },
  { src: "/media/pins-bg/pin-bg-cola.png", left: 78, top: 8, vw: 9, px: 94, fx: 52, fy: -22, fr: 200, rot: 12, delay: 0.7 },
  ...
  { src: "/media/pins-bg/pin-bg-ddw-blue.png", left: 20, top: 84, vw: 7, px: 78, fx: -20, fy: 46, fr: 150, rot: -21, delay: 4.2 },
  { src: "/media/pins-bg/pin-bg-ddw-video.png", left: 90, top: 82, vw: 7, px: 78, fx: 26, fy: 44, fr: -140, rot: -26, delay: 4.9 },
